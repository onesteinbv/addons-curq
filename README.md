...
CURQ can also be deployed on Kubernetes using the [CURQ Helm Chart](https://github.com/onesteinbv/helm-charts).

```sh
helm repo add onestein https://onesteinbv.github.io/helm-charts
helm install curq onestein/curq
```
