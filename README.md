...
TODO: Purpose-built
TODO: Explain bundles, mention addons-generic and addons-oca
...
- **Surveys** (`survey_install`): Create, distribute, and analyze questionnaires to gather feedback, opinions, or data efficiently
...
- **Community Builder** (`website_membership_install`): Empower your community with tools to improve member engagement, content sharing, 
  and more
